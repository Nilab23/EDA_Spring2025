...
```{r}
# I'm checking the class of the collectDate and I see that is a factor not a date
...
# Now, I'm checking which dates the Litter was sampled. After running the code, I can see the Litter was sampled with dates (2018-08-02 2018-08-30)
...
Furthermore,the boxplot is simple and readable. However, the violin plot is not as readable as boxplot and the distribution of the data is not also clear.
