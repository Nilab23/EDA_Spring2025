...
#10 checling the dimension of the dataset
dim(final_tidy_data)
...
drop_na with na.omit and the dimesnion has changed from 8976 9 to 182 5, 
which means na.omit has reduced the dataset size significantly.
